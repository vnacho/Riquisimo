...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20201226125725_pedidocompras")]
    partial class pedidocompras
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 12, 26, 13, 57, 24, 929, DateTimeKind.Local).AddTicks(1613),
                            Modified = new DateTime(2020, 12, 26, 13, 57, 24, 929, DateTimeKind.Local).AddTicks(2150),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 12, 26, 13, 57, 24, 929, DateTimeKind.Local).AddTicks(2719),
                            Modified = new DateTime(2020, 12, 26, 13, 57, 24, 929, DateTimeKind.Local).AddTicks(2729),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 12, 26, 13, 57, 24, 929, DateTimeKind.Local).AddTicks(2750),
                            Modified = new DateTime(2020, 12, 26, 13, 57, 24, 929, DateTimeKind.Local).AddTicks(2753),
                            Name = "Presupuesto"
                        });
                });
