...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200428140633_DocumentType")]
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 4, 28, 16, 6, 33, 33, DateTimeKind.Local).AddTicks(190),
                            Modified = new DateTime(2020, 4, 28, 16, 6, 33, 33, DateTimeKind.Local).AddTicks(762),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 4, 28, 16, 6, 33, 33, DateTimeKind.Local).AddTicks(1356),
                            Modified = new DateTime(2020, 4, 28, 16, 6, 33, 33, DateTimeKind.Local).AddTicks(1367),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 4, 28, 16, 6, 33, 33, DateTimeKind.Local).AddTicks(1387),
                            Modified = new DateTime(2020, 4, 28, 16, 6, 33, 33, DateTimeKind.Local).AddTicks(1390),
                            Name = "Presupuesto"
                        });
                });
