...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20210107102209_compraAlbaranes")]
    partial class compraAlbaranes
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 1, 7, 11, 22, 8, 798, DateTimeKind.Local).AddTicks(8685),
                            Modified = new DateTime(2021, 1, 7, 11, 22, 8, 798, DateTimeKind.Local).AddTicks(9251),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2021, 1, 7, 11, 22, 8, 798, DateTimeKind.Local).AddTicks(9837),
                            Modified = new DateTime(2021, 1, 7, 11, 22, 8, 798, DateTimeKind.Local).AddTicks(9848),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2021, 1, 7, 11, 22, 8, 798, DateTimeKind.Local).AddTicks(9866),
                            Modified = new DateTime(2021, 1, 7, 11, 22, 8, 798, DateTimeKind.Local).AddTicks(9870),
                            Name = "Presupuesto"
                        });
                });
