...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200609094503_databaseFields")]
    partial class databaseFields
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 6, 9, 11, 45, 2, 686, DateTimeKind.Local).AddTicks(5478),
                            Modified = new DateTime(2020, 6, 9, 11, 45, 2, 686, DateTimeKind.Local).AddTicks(6011),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 6, 9, 11, 45, 2, 686, DateTimeKind.Local).AddTicks(6572),
                            Modified = new DateTime(2020, 6, 9, 11, 45, 2, 686, DateTimeKind.Local).AddTicks(6581),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 6, 9, 11, 45, 2, 686, DateTimeKind.Local).AddTicks(6602),
                            Modified = new DateTime(2020, 6, 9, 11, 45, 2, 686, DateTimeKind.Local).AddTicks(6606),
                            Name = "Presupuesto"
                        });
                });
