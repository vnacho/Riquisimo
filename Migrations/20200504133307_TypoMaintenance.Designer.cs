...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200504133307_TypoMaintenance")]
    partial class TypoMaintenance
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 5, 4, 15, 33, 6, 535, DateTimeKind.Local).AddTicks(7419),
                            Modified = new DateTime(2020, 5, 4, 15, 33, 6, 535, DateTimeKind.Local).AddTicks(7998),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 5, 4, 15, 33, 6, 535, DateTimeKind.Local).AddTicks(8602),
                            Modified = new DateTime(2020, 5, 4, 15, 33, 6, 535, DateTimeKind.Local).AddTicks(8613),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 5, 4, 15, 33, 6, 535, DateTimeKind.Local).AddTicks(8635),
                            Modified = new DateTime(2020, 5, 4, 15, 33, 6, 535, DateTimeKind.Local).AddTicks(8638),
                            Name = "Presupuesto"
                        });
                });
