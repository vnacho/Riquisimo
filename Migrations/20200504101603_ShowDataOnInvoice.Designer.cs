...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200504101603_ShowDataOnInvoice")]
    partial class ShowDataOnInvoice
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 5, 4, 12, 16, 3, 51, DateTimeKind.Local).AddTicks(530),
                            Modified = new DateTime(2020, 5, 4, 12, 16, 3, 51, DateTimeKind.Local).AddTicks(1068),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 5, 4, 12, 16, 3, 51, DateTimeKind.Local).AddTicks(1647),
                            Modified = new DateTime(2020, 5, 4, 12, 16, 3, 51, DateTimeKind.Local).AddTicks(1657),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 5, 4, 12, 16, 3, 51, DateTimeKind.Local).AddTicks(1677),
                            Modified = new DateTime(2020, 5, 4, 12, 16, 3, 51, DateTimeKind.Local).AddTicks(1681),
                            Name = "Presupuesto"
                        });
                });
