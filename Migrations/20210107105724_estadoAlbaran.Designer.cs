...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20210107105724_estadoAlbaran")]
    partial class estadoAlbaran
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 1, 7, 11, 57, 23, 752, DateTimeKind.Local).AddTicks(7274),
                            Modified = new DateTime(2021, 1, 7, 11, 57, 23, 752, DateTimeKind.Local).AddTicks(7845),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2021, 1, 7, 11, 57, 23, 752, DateTimeKind.Local).AddTicks(8749),
                            Modified = new DateTime(2021, 1, 7, 11, 57, 23, 752, DateTimeKind.Local).AddTicks(8760),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2021, 1, 7, 11, 57, 23, 752, DateTimeKind.Local).AddTicks(8781),
                            Modified = new DateTime(2021, 1, 7, 11, 57, 23, 752, DateTimeKind.Local).AddTicks(8784),
                            Name = "Presupuesto"
                        });
                });
