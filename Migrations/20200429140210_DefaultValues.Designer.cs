...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200429140210_DefaultValues")]
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 4, 29, 16, 2, 9, 870, DateTimeKind.Local).AddTicks(551),
                            Modified = new DateTime(2020, 4, 29, 16, 2, 9, 870, DateTimeKind.Local).AddTicks(1094),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 4, 29, 16, 2, 9, 870, DateTimeKind.Local).AddTicks(1654),
                            Modified = new DateTime(2020, 4, 29, 16, 2, 9, 870, DateTimeKind.Local).AddTicks(1668),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 4, 29, 16, 2, 9, 870, DateTimeKind.Local).AddTicks(1688),
                            Modified = new DateTime(2020, 4, 29, 16, 2, 9, 870, DateTimeKind.Local).AddTicks(1691),
                            Name = "Presupuesto"
                        });
                });
