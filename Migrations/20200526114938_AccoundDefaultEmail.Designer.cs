...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200526114938_AccoundDefaultEmail")]
    partial class AccoundDefaultEmail
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 5, 26, 13, 49, 38, 293, DateTimeKind.Local).AddTicks(5563),
                            Modified = new DateTime(2020, 5, 26, 13, 49, 38, 293, DateTimeKind.Local).AddTicks(6140),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 5, 26, 13, 49, 38, 293, DateTimeKind.Local).AddTicks(6845),
                            Modified = new DateTime(2020, 5, 26, 13, 49, 38, 293, DateTimeKind.Local).AddTicks(6859),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 5, 26, 13, 49, 38, 293, DateTimeKind.Local).AddTicks(6882),
                            Modified = new DateTime(2020, 5, 26, 13, 49, 38, 293, DateTimeKind.Local).AddTicks(6885),
                            Name = "Presupuesto"
                        });
                });
