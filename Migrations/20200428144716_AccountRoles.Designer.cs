...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200428144716_AccountRoles")]
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 4, 28, 16, 47, 15, 504, DateTimeKind.Local).AddTicks(8761),
                            Modified = new DateTime(2020, 4, 28, 16, 47, 15, 504, DateTimeKind.Local).AddTicks(9322),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 4, 28, 16, 47, 15, 504, DateTimeKind.Local).AddTicks(9901),
                            Modified = new DateTime(2020, 4, 28, 16, 47, 15, 504, DateTimeKind.Local).AddTicks(9911),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 4, 28, 16, 47, 15, 504, DateTimeKind.Local).AddTicks(9932),
                            Modified = new DateTime(2020, 4, 28, 16, 47, 15, 504, DateTimeKind.Local).AddTicks(9935),
                            Name = "Presupuesto"
                        });
                });
