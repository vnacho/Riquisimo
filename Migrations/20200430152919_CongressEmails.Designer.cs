...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200430152919_CongressEmails")]
    partial class CongressEmails
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 4, 30, 17, 29, 18, 988, DateTimeKind.Local).AddTicks(7264),
                            Modified = new DateTime(2020, 4, 30, 17, 29, 18, 988, DateTimeKind.Local).AddTicks(7818),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 4, 30, 17, 29, 18, 988, DateTimeKind.Local).AddTicks(8392),
                            Modified = new DateTime(2020, 4, 30, 17, 29, 18, 988, DateTimeKind.Local).AddTicks(8403),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 4, 30, 17, 29, 18, 988, DateTimeKind.Local).AddTicks(8424),
                            Modified = new DateTime(2020, 4, 30, 17, 29, 18, 988, DateTimeKind.Local).AddTicks(8427),
                            Name = "Presupuesto"
                        });
                });
