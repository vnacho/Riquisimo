...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200922062115_AccessInvoices")]
    partial class AccessInvoices
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 9, 22, 8, 21, 14, 712, DateTimeKind.Local).AddTicks(2297),
                            Modified = new DateTime(2020, 9, 22, 8, 21, 14, 712, DateTimeKind.Local).AddTicks(2875),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 9, 22, 8, 21, 14, 712, DateTimeKind.Local).AddTicks(3773),
                            Modified = new DateTime(2020, 9, 22, 8, 21, 14, 712, DateTimeKind.Local).AddTicks(3785),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 9, 22, 8, 21, 14, 712, DateTimeKind.Local).AddTicks(3804),
                            Modified = new DateTime(2020, 9, 22, 8, 21, 14, 712, DateTimeKind.Local).AddTicks(3807),
                            Name = "Presupuesto"
                        });
                });
