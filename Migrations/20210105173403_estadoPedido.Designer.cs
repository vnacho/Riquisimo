...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20210105173403_estadoPedido")]
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 1, 5, 18, 34, 2, 749, DateTimeKind.Local).AddTicks(5203),
                            Modified = new DateTime(2021, 1, 5, 18, 34, 2, 749, DateTimeKind.Local).AddTicks(5767),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2021, 1, 5, 18, 34, 2, 749, DateTimeKind.Local).AddTicks(6367),
                            Modified = new DateTime(2021, 1, 5, 18, 34, 2, 749, DateTimeKind.Local).AddTicks(6382),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2021, 1, 5, 18, 34, 2, 749, DateTimeKind.Local).AddTicks(6402),
                            Modified = new DateTime(2021, 1, 5, 18, 34, 2, 749, DateTimeKind.Local).AddTicks(6405),
                            Name = "Presupuesto"
                        });
                });
