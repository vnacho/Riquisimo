...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20210107120847_RelacionLineasAlbaranPedido")]
    partial class RelacionLineasAlbaranPedido
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 1, 7, 13, 8, 46, 638, DateTimeKind.Local).AddTicks(642),
                            Modified = new DateTime(2021, 1, 7, 13, 8, 46, 638, DateTimeKind.Local).AddTicks(1552),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2021, 1, 7, 13, 8, 46, 638, DateTimeKind.Local).AddTicks(2268),
                            Modified = new DateTime(2021, 1, 7, 13, 8, 46, 638, DateTimeKind.Local).AddTicks(2281),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2021, 1, 7, 13, 8, 46, 638, DateTimeKind.Local).AddTicks(2306),
                            Modified = new DateTime(2021, 1, 7, 13, 8, 46, 638, DateTimeKind.Local).AddTicks(2310),
                            Name = "Presupuesto"
                        });
                });
