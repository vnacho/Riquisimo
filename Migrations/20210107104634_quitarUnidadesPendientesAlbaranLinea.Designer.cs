...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20210107104634_quitarUnidadesPendientesAlbaranLinea")]
    partial class quitarUnidadesPendientesAlbaranLinea
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 1, 7, 11, 46, 33, 620, DateTimeKind.Local).AddTicks(8896),
                            Modified = new DateTime(2021, 1, 7, 11, 46, 33, 620, DateTimeKind.Local).AddTicks(9457),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2021, 1, 7, 11, 46, 33, 621, DateTimeKind.Local).AddTicks(58),
                            Modified = new DateTime(2021, 1, 7, 11, 46, 33, 621, DateTimeKind.Local).AddTicks(68),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2021, 1, 7, 11, 46, 33, 621, DateTimeKind.Local).AddTicks(88),
                            Modified = new DateTime(2021, 1, 7, 11, 46, 33, 621, DateTimeKind.Local).AddTicks(91),
                            Name = "Presupuesto"
                        });
                });
