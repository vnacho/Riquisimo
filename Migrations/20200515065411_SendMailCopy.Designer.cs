...
namespace Ferpuser.Migrations
{
    ...
    [Migration("20200515065411_SendMailCopy")]
    partial class SendMailCopy
    {
            ...
            modelBuilder.Entity("Ferpuser.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 5, 15, 8, 54, 10, 914, DateTimeKind.Local).AddTicks(7937),
                            Modified = new DateTime(2020, 5, 15, 8, 54, 10, 914, DateTimeKind.Local).AddTicks(8490),
                            Name = "Factura"
                        },
                        new
                        {
                            Id = new Guid("043d73bf-1516-4672-affe-4f0836048f40"),
                            Created = new DateTime(2020, 5, 15, 8, 54, 10, 914, DateTimeKind.Local).AddTicks(9068),
                            Modified = new DateTime(2020, 5, 15, 8, 54, 10, 914, DateTimeKind.Local).AddTicks(9079),
                            Name = "Factura proforma"
                        },
                        new
                        {
                            Id = new Guid("fd4d4c0d-53cb-4844-a520-cba0dac861c4"),
                            Created = new DateTime(2020, 5, 15, 8, 54, 10, 914, DateTimeKind.Local).AddTicks(9101),
                            Modified = new DateTime(2020, 5, 15, 8, 54, 10, 914, DateTimeKind.Local).AddTicks(9104),
                            Name = "Presupuesto"
                        });
                });
